                   ...
                   echo '<tr class="align-middle"><th class="col-3">No result found.</th> </tr>';
                    ...
                    <tr class="align-middle" id="">
                        ...
                        <td class="text-nowrap">
                            ...
                            <img id="" src="{{asset('/storage/'.$plat -> picture)}}" style="width:3rem;" />
                        </td>
                        ...
                        <td class="text-end">
                            ...
                            <form style="display:inline" method="POST" action="{{route('plats.destroy',['plat'=>$plat->id])}}">
                                @csrf
                                @method('DELETE')
        ...
        <div class="modal-dialog modal-dialog-centered mt-3 mb-1">
            <div class="modal-content background ">
                ...
                <div class="modal-footer">
                    ...
                    <button id="savePlat" type="submit" name="savePlat" class="btn btn-outline-primary">Save</button>
