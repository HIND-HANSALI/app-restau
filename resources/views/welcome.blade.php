...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" >
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Youcode Restau</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
         ...
         <div class="row">
                ...
                <div class="col-md-6  h-100 justify-content-center">
                    ...
                    <div class="buttons pt-2">
                        <a href="#" class="btn btn-primary fw-bold">Our story</a>
                        <a href="#" class="btn btn-outline-secondary fw-bold ms-3">Menus</a>

                    </div>
                </div>
                <!-- image -->
                <div class="col-md-6">
                    <img src="pictures/menu.jpg"  alt="jeu" class="w-100  vh-100">
